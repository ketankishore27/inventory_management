...
export default function EowResourcesPage() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      setError(null)
      const res = await fetch('http://127.0.0.1:8000/showEowResources', {
        method: 'POST',
  ...
  return (
    <div className="p-6">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">EOW Resources</h1>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              {loading && data.length === 0 ? (
                ...
                <tr>
                  <td colSpan={14} className="px-4 py-6 text-center text-sm text-gray-500">No EOW resources found.</td>
                </tr>
              ) : (
